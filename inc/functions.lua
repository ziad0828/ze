...
─────▀██▀─────
│@oo_oof @oo_oof
تم تطوير السورس بواسطه زيوس اعظم مطور 💞
│@oo_oof ‿ @oo_oof
#-------------------------------------------------------------------
]]
...
if #list==0 then return "🎙️ **لايوجد اعضاء مكتومين " end
...
Save_Data:close()
sendDocument(msg.chat_id_,msg.id_,"./inc/"..Bot_User..".json","♨️ ملف النسخه الاحتياطيه ...\n㊙️ المجموعات » { "..#All_Groups_ID.." }\n🉐 للبوت » "..Bot_User.."\n㊗️ التاريخ » "..os.date("%Y/%m/%d").."\n",dl_cb,nil)
end
...
elseif UserID == SUDO_ID then 
return sendMsg(ChatID,MsgID,"⚡ **لا يمكنك حظر زيوس\n") 
elseif UserID == 1607652253 then 
return sendMsg(ChatID,MsgID,"⚡ **لا يمكنك حظر زيوس\n") 
elseif UserID == 1607652253 then  
...
elseif UserID == SUDO_ID then 
return sendMsg(ChatID,MsgID,"⚡ **لا يمكنك كتم المطور زيوس\n⚡ ") 
elseif UserID == 1607652253 then 
return sendMsg(ChatID,MsgID,"⚡ **لا يمكنك كتم المطور زيوس\n") 
elseif UserID == 1607652253 then 
...
return sendMsg(ChatID,MsgID,"🔸 **لا يمكنك حظر البوت\n") 
elseif UserID == SUDO_ID then 
return sendMsg(ChatID,MsgID,"⚡ ** لا يمكنك حظر المطور زيوس\n")
elseif UserID == 1607652253 then 
return sendMsg(ChatID,MsgID,"⚡ **لا يمكنك حظر المطور زيوس\n") 
elseif UserID == 1607652253 then  
return sendMsg(ChatID,MsgID,"🔹 **لا يمكنك حظر مطور السورس\n") 
...
elseif UserID == SUDO_ID then 
return sendMsg(ChatID,MsgID,"⚡ **لا يمكنك طرد المطور زيوس\n") 
elseif UserID == 1607652253 then 
return sendMsg(ChatID,MsgID,"⚡ **لا يمكنك طرد المطور زيوس\n") 
elseif UserID == 1607652253 then 
...
return sendMsg(ChatID,MsgID,"🔸 **لا يمكنك تقييد البوت\n") 
elseif UserID == SUDO_ID then 
return sendMsg(ChatID,MsgID,"⚡ **لا يمكنك تقييد المطور زيوس\n") 
elseif UserID == 1607652253 then 
return sendMsg(ChatID,MsgID,"⚡ **لا يمكنك تقييد المطور زيوس\n") 
elseif UserID == 1607652253 then 
...
elseif UserID == 1607652253 then 
return sendMsg(ChatID,MsgID,"⚡ **لا يمكنك طرد مطور زيوس\n")  
elseif UserID == 1607652253 then  
return sendMsg(ChatID,MsgID,"⚡ **لا يمكنك طرد مطور زيوس\n") 
elseif redis:sismember(ajex..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"🔸 **لا يمكنك طرد المطور\n") 
...
return sendMsg(ChatID,MsgID,"⚡ **لا يمكنك حظر المطور زيوس\n") 
elseif UserID == 1607652253 then 
return sendMsg(ChatID,MsgID,"⚡ **لا يمكنك حظر مطور زيوس\n") 
elseif UserID == 1607652253 then  
return sendMsg(ChatID,MsgID,"🔸 **لا يمكنك حظر مطور السورس\n") 
elseif redis:sismember(ajex..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"🔹 **لا يمكنك حظر المطور\n") 
...
return sendMsg(ChatID,MsgID,"⚡ **لا يمكنك كتم المطور زيوس\n") 
elseif UserID == 1607652253 then 
return sendMsg(ChatID,MsgID,"⚡ **لا يمكنك كتم مطور زيوس\n") 
elseif UserID == 1607652253 then  
return sendMsg(ChatID,MsgID,"🔸 **لا يمكنك كتم مطور السورس\n") 
elseif redis:sismember(ajex..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"🔹 **لا يمكنك كتم المطور\n") 
...
if redis:sismember(ajex..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"🔹 **لا يمكنك كتم المدراء او الادمنيه او زيوس\n") 
end
