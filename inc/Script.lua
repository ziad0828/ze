...
if redis:get(ajex.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		...
		sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,'- ɴᴀᴍᴇ 𖣴   '..Namei..'    \n- ᴜѕᴇʀɴᴀᴍᴇ 𖣴  '..UserNameID..' .\n- ᴍѕɢѕ 𖣴    '..msgs..' .\n- ѕᴛᴀᴛѕ 𖣴  '..msg.TheRank..' .\n- ʏᴏᴜʀ ɪᴅ 𖣴  '..msg.sender_user_id_..' .\n- ᴄʜ 𖣴 @zeus_source .',dl_cb,nil)
		else
...
if not msg.SudoBase then return"父 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
...
if MsgText[1] == "رتبتي" then return '父 ** رتبتك هنا  ←  ( '..msg.TheRank..' )\n' end

----------------- استقبال الرسائل ---------------
if MsgText[1] == "الغاء الامر ✖父" or MsgText[1] == "الغاء" then
if not msg.Admin then return "父 **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
...
sendMsg(msg.chat_id_,msg.id_,' *父* يوجد تحديث جديد الان \n*父* جاري تنزيل وتثبيت التحديث  ...' )
redis:set(ajex..":VERSION",GetVerison)
return false
else
return "父الاصدار الحالي : *v"..version.."* \n*父* لديـك احدث اصدار \n"
end
return false
end

if MsgText[1] == 'اصدار السورس' or MsgText[1] == 'الاصدار' then
return '父 اصدار سورس زيوس : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'父 ** جارٍ رفع النسخه انتظر قليلا ... \n')
end
end,nil)
else 
sendMsg(msg.chat_id_,msg.id_,"父 ** عذراً النسخه الاحتياطيه هذا ليست للبوت » ["..Bot_User.."]  \n")
end
else 
sendMsg(msg.chat_id_,msg.id_,'父 ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس اجـكـس يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
sendMsg(msg.chat_id_,msg.id_,'父 ** عذراً الملف ليس بصيغه Json !?\n')
end 
else
sendMsg(msg.chat_id_,msg.id_,'父 ** عذراً هذا ليس ملف النسحه الاحتياطيه للمجموعات\n')
end 
end,nil)
else 
return "⌯ ** ارسل ملف النسخه الاحتياطيه اولا\n父 ** ثم قم بالرد على الملف وارسل \" `رفع نسخه الاحتياطيه` \" "
end 
return false
end
...
if not msg.SudoBase then return"父 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return "父 البوت شـغــال ." 
end

if (MsgText[1]== "ايدي" or MsgText[1]=="ايديي🆔") and msg.type == "pv" then return  "\n父 اهلاً عزيزي المطور ايديك :\n\n父 "..msg.sender_user_id_.."\n"  end

if MsgText[1]== "قناة السورس" and msg.type == "pv" then
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/zeus_source"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : زيوس](https://t.me/zeus_source)' ,nil,inline,msg.id_)
return false
end

if (MsgText[1]== "الاحصائيات 💥" or MsgText[1]=="الاحصائيات") then
if not msg.SudoBase then return"父 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '父 الاحصائيات . \n\n父 **عدد المجموعات المفعله : '..redis:scard(ajex..'group:ids')..'\n父 **عدد المشتركين في البوت : '..redis:scard(ajex..'users')..'\n'
end
---------------[End Function data] -----------------------
...
߷ ︙ م4 🔻 اوامر الخدمه 
߷ ︙ م5 🔻  اوامر المطور
߷ ︙ .[قـنـاه الـسـورس](t.me/zeus_source) 
߷ ︙ [ مـطـور الـسـورس ](t.me/oo_oof)
܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀
...
«» ❬اوامـر المطـور❭ 
܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀
个 ︙ تفعيـل «» ❬لتفعيل البوت ❭
个 ︙ تعطيل «» ❬لتعطيل البوت ❭
个 ︙ رفع منشى «» ❬رفع منشى بالبوت❭
܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀
个 ︙ اذاعه «» ❬لنشر رساله لكل المجموعات❭
个 ︙ اذاعه خاص ◄«»لنشر رساله لكل المشتركين خاص❭
个 ︙ اذاعه عام «» ❬لنشر رساله لكل المجموعات والخاص❭
个 ︙ اذاعه عام بالتوجيه «» ❬لنشر منشور قناتك بابتوجيه للكل❭
个 ︙ تنظيف المجموعات«»  ❬لمسح المجموعات الوهميه❭
تنظيف المشتركين «» ❬لمسح المشتركين الوهميين❭
܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀
个 ︙ تحديث «» ❬لتحديث ملفات البوت❭
个 ︙ تحديث السورس «» ❬لتحديث السورس الى اصدار احدث❭
܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀
⌯ ︙ ** لـلإسـتـفـسـار ↤︎ ]]..SUDO_USER
sendMsg(msg.chat_id_,msg.id_,text)
return false
...
[𝐙 𝐄 𝐔 𝐒 ⚡](t.me/zeus_source) ⚡

[𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐙 𝐄 𝐔 𝐒 ⚡](t.me/zeus_source)
ـــــــــــــــــــــــــــــــــــــ⚡𝖅𝕰𝖀𝕾ـــــــــــــــــــــــــ
]]
end
...
elseif Text== "زيوس" or Text== "زياد"  then return sendMsg(msg.chat_id_,msg.id_,"[صاعق الكل ⚡](https://t.me/zeus_source)")
...
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕](https://t.me/zeus_source) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔](https://t.me/zeus_source)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑](https://t.me/zeus_source)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘](https://t.me/zeus_source)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹](https://t.me/zeus_source)")
end 
end 
elseif Text== "مين ضافني" or Text== "منو ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت مكانك كل مكان يا مطور♕](https://t.me/zeus_source) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه](https://t.me/zeus_source)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/zeus_source)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/zeus_source)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/zeus_source)")
